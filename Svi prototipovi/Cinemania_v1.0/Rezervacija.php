<?php session_start(); if (isset($_SESSION['user'])==false)
{
...
<tr >
  ...
  <p><font size='6'>Korisnik</font></p>
	<a class="stavka" href="PredlogFilma.php"><font size='5'>Preporuci mi film</font></a>
		
         <a  class="stavka" href="PrijaviGresku.php"><font 	size='5'>Prijavi gresku</font></a>
